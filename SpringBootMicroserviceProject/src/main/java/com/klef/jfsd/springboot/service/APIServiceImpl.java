...
public class APIServiceImpl implements APIService
{
	...
	{
		Object[] students = restTemplate.getForObject("http://localhost:2024/student/viewall", Object[].class); //multiple objects so that take object
	...
	{
		return restTemplate.getForObject("http://localhost:2024/student/display?id="+sid, Object.class);
